    ...
    return (<div className="flex items-start justify-start h-screen">
            ...
            backgroundRepeat: 'no-repeat',
                        ...
                        <form className="p-6 space-y-9 min-w-full text-left">
                            <div className="mb-4 relative min-w-full">
                                ...
                                <input className={`w-full p-1.5 input-style ${!coolerIdValid ? 'border-red-500' : ''}`} id="coolerid" type="text" placeholder="Cooler ID" value={coolerId} onChange={(e) => {
            ...
            setCoolerIdValid(!!e.target.value.trim());
                            ...
                            <div className="mb-4 relative min-w-full">
                                ...
                                <input className={`w-full p-1.5 input-style ${!coolerNameValid ? 'border-red-500' : ''}`} id="coolername" type="text" placeholder="Cooler Name" value={coolerName} onChange={(e) => {
