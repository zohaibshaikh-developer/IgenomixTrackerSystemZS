      ...
      <Components.Container>
        <Components.SignUpContainer signingIn={signIn}>
          <Components.Form>
            ...
            <Components.Input type="text" name="Name" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)}/>
            <Components.Input type="email" name="Email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
            <Components.Input type="text" name="ContactNo" placeholder="Contact Number" value={contactNumber} onChange={(e) => setContactNumber(e.target.value)}/>
            <Components.Input type="text" name="Username" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)}/>
            <Components.Input type={showPassword ? "text" : "password"} name="PasswordRegister" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)}/>
            <span style={{ cursor: 'pointer', color: 'black', alignSelf: 'flex-end', backgroundColor: '#6EF3D6', padding: '0.6%', fontWeight: 'bold', borderRadius: '6%', fontSize: '85%' }} onClick={() => setShowPassword(!showPassword)}>
              {showPassword ? 'Hide' : 'Show'} Password
            </span>
            {errorMessage && (<span style={{ color: 'red', margin: '10px 0', display: 'block' }}>
              {errorMessage}
            </span>)}
        ...
        <Components.SignInContainer signingIn={signIn}>
          <Components.Form>
            ...
            {registrationSuccess && (<span style={{ color: 'green', margin: '10px 0', display: 'block', fontSize: '18px' }}>
              Registration successful! Please sign in.
            </span>)}
            <Components.Input type="text" name="Username" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)}/>
            <Components.Input type={showPassword ? "text" : "password"} name="Password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)}/>
          <span style={{ cursor: 'pointer', color: 'black', alignSelf: 'flex-end', backgroundColor: '#6EF3D6', padding: '0.6%', fontWeight: 'bold', borderRadius: '6%', fontSize: '85%' }} onClick={() => setShowPassword(!showPassword)}>
            {showPassword ? 'Hide' : 'Show'} Password
          </span>
          {errorMessage && (<span style={{ color: 'red', margin: '10px 0', display: 'block' }}>
