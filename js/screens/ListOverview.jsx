...
const UpdateoverviewModal = ({ isOpen, onClose, overviewId, overviewName, onUpdate }) => {
            ...
            boxShadow: '0 1px 2px 0 black',
                ...
                <div className='space-y-7'>
                    <div className="mb-4">
                        ...
                        <input type="text" value={newoverviewId} 
    // readOnly
    onChange={(e) => setNewoverviewId(e.target.value)} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300"/>
                    </div>
                    <div className="mb-4">
                        <label className="block text-lg font-medium text-white text-start mb-3">overview Name</label>
                        <input type="text" value={newoverviewName} onChange={(e) => setNewoverviewName(e.target.value)} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300"/>
                    </div>
                </div>
...
const DeleteConfirmationModal = ({ isOpen, onClose, onDelete, overviewId, overviewName }) => {
    const handleDelete = () => {
        onDelete(overviewId);
        onClose();
    };
...
const ListOverview = () => {
    ...
    const [filteredoverviews, setFilteredoverviews] = useState(overviews);
    ...
    useEffect(() => {
        setFilteredoverviews(overviews.filter((overview) => overview.clinicName && overview.clinicName.includes(filterText)));
    ...
    return (<>
            ...
            {!isLoading && (<div className="flex flex-col lg:flex-row xl:flex-col">
                    ...
                    <div className={`flex-1 p-4 lg:p-10 ${isSidebarOpen ? 'lg:ml-52 xl:ml-52' : ''}`}>
                        ...
                        <div className="flex flex-col items-center justify-center mt-2 overflow-y-auto">
                            ...
                            <UpdateoverviewModal isOpen={isUpdateModalOpen} onClose={() => setUpdateModalOpen(false)} overviewId={selectedoverview.overviewId} overviewName={selectedoverview.overviewName} onUpdate={handleUpdate}/>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center mt-2 overflow-y-auto">
                            ...
                            <DeleteConfirmationModal isOpen={isDeleteModalOpen} onClose={() => setDeleteModalOpen(false)} onDelete={handleDeleteConfirm} overviewId={selectedDeleteoverview.overviewId} overviewName={selectedDeleteoverview.overviewName}/>
        ...
        value={filterText} onChange={(e) => setFilterText(e.target.value)}/>
                            ...
                            {filteredoverviews.length > 0 ? (<div className="text-black w-full overflow-x-auto">
                                    <table className="min-w-full bg-white border border-gray-300">
                                        ...
                                        <tbody>
                                            {filteredoverviews.map((overview, index) => (<tr key={index} className="border-t font-medium">
