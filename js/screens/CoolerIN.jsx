            ...
            backgroundRepeat: 'no-repeat',
                        ...
                        <form className="p-6 space-y-9 min-w-full text-left">
                            ...
                            <div className="mb-4 relative min-w-full">
                                ...
                                <select className="w-full p-1.5 input-style" value={selectedOverview} onChange={(e) => {
            setSelectedOverview(e.target.value);
        }} required>
                                    <option value="" disabled>Select the overview entry</option>
                                    {overviewList.map(overview => (<option key={overview.rowId} value={overview.Sr_No}>
                            ...
                            <div className="mb-4 relative min-w-full">
                                ...
                                <input type="number" className="w-full p-1.5 input-style" value={quantity} onChange={(e) => setQuantity(e.target.value)} placeholder="Enter Quantity" required style={{ '::placeholder': { color: 'white' } }}/>
                            </div>

                            <div className="mb-4 relative min-w-full">
                                <label className='text-black font-semibold block text-md mb-3'>Date Received</label>
                                <DatePicker selected={dateReceived} onChange={(date) => setDateReceived(date)} dateFormat="dd/MM/yyyy" className="w-full p-1.5 input-style" placeholderText="Select Date" required/>
                            </div>
