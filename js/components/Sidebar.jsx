...
const Sidebar = ({ isSidebarOpen }) => {
    ...
    return (<div className={`sidebar ${isSidebarOpen ? 'lg:w-60 md:w-60 sm:w-20 w-40' : 'lg:w-0'} md:w-0 sm:w-0 w-0 z-50`}>
      {shouldRenderContent && (<div className={`nav-content ${isSidebarOpen ? 'lg:text-center md:text-center sm:text-center text-center' : ''}`}>
